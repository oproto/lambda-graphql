...
interface ResolverConfig {
  ...
  role?: string;
  policies?: string[];
  // Resolver code (generated by source generator)
  resolverCode: string;
}
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    for (const resolver of resolverManifest.resolvers) {
      ...
      const lambdaFunction = new lambda.Function(this, functionId, {
        ...
        code: lambda.Code.fromAsset(path.join(__dirname, '../../Oproto.Lambda.GraphQL.Examples/bin/Release/net8.0')),
        role: lambdaRole,
    ...
    for (const resolverConfig of resolverManifest.resolvers) {
      ...
      // Create resolver using resolverCode from the source generator manifest
      new appsync.Resolver(this, `${resolverConfig.typeName}${resolverConfig.fieldName}Resolver`, {
        ...
        code: appsync.Code.fromInline(resolverConfig.resolverCode),
      });
    }
